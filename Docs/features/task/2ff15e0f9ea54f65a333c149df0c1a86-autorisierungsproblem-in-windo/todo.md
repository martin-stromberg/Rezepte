...
Branch: `task/2ff15e0f9ea54f65a333c149df0c1a86-autorisierungsproblem-in-windo`

| Status | Schritt | Beschreibung | Artefakt |
|--------|---------|--------------|----------|
| [x] | 1 | Branch-Name ermitteln | – |
| [x] | 2 | Verzeichnisstruktur vorbereiten | `docs/features/task/2ff15e0f9ea54f65a333c149df0c1a86-autorisierungsproblem-in-windo/` |
| [x] | – | Einstiegspunkt ermitteln | – |
| [ ] | 3 | Anforderung übersetzen | `requirement.md` |
