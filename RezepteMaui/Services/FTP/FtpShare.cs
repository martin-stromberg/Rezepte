...
namespace Rezepte.Services.Ftp
{
    ...
    public class FtpShare: RemoteShare
    {
        ...
        {
            UploadFile(remoteFilePath, localFilePath, FtpRemoteExists.Skip);            
        }

        internal void UploadFile(string remoteFilePath, string localFilePath, FtpRemoteExists remoteExistsAction)
        {
        ...
        internal bool FileExists(string remoteFilePath)
        {
